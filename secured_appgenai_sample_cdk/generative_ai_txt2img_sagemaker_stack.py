...
class SageMakerLLMTxt2ImgEndpointStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, model_info, vpc_stack: ec2.Vpc, **kwargs) -> None:
        ...
        txt2txt_endpoint_construct = SageMakerEndpointConstruct(self, "SageMaker-Txt2Img-Endpoint",
                                                                project_prefix="SecureAppGenAISample",
                                                                role_arn=role.role_arn,
                                                                model_name="StabilityAIText2Img",
        ...
        ssm.StringParameter(self, 'txt2img_sm_endpoint', parameter_name='txt2img_sm_endpoint', string_value=txt2txt_endpoint_construct.endpoint_name)